...
const Navbar = () => {
  ...
  useEffect(() => {
    const fetchTeacherData = async () => {
      try {
        const response = await fetch("https://9d11-2409-40c1-4150-76bb-5c2a-b24b-c84-3c83.ngrok-free.app/teacher/home",
          {
            method: "GET",
            headers: {
  ...
  const handlePhotoUpload = async () => {
    ...
    try {
      const response = await fetch("https://9d11-2409-40c1-4150-76bb-5c2a-b24b-c84-3c83.ngrok-free.app/teacher/uploadPhoto", {
        method: "POST",
        headers: {
      ...
      const updatedTeacherData = await fetch("https://9d11-2409-40c1-4150-76bb-5c2a-b24b-c84-3c83.ngrok-free.app/teacher/home",{
        method: "POST",
        headers: {
          "Authorization": `Bearer ${BearerToken}`,
          "ngrok-skip-browser-warning": "true", // Bypasses ngrok warning
      ...
      <div className="relative">
        ...
        {isMenuOpen && (
          <div className="absolute top-12 right-0 bg-white text-black p-4 rounded shadow-lg z-10 w-64">
            <p className="font-bold">{teacherData.teacherName}</p>
            <p className="text-sm mb-4">{teacherData.teacherEmail}</p>
            ...
            {uploadStatus && <p className="text-xs mt-2 text-center">{uploadStatus}</p>}
          </div>
        )}
      </div>
    </nav>
